<template>
  <template v-if="!loading">
    <!-- Submit -->
    <TitleAndButtons title="Add Journal Entry">
      <!--    Buttons-->
    ...
    <!--  <div class="card">-->
    <el-form :model="data" :rules="rules" v-loading="loading" ref="formRef">
      <!-- Initials -->
        ...
        <table class="table mb-0">
          <tbody class="">
            <tr class="justify-content-end">
              <td>
                <label class="required fw-bold mb-1">Entry Type</label>

                <el-form-item class="mb-0" prop="entry_type">
                  <el-select
                    v-model="data.entry_type"
                    filterable
                    placeholder="Select Payment Type"
                    size="small"
                  >
                    <el-option label="Journal Entry" value="Journal Entry" />
                    <el-option label="Bank Entry" value="Bank Entry" />
                    <el-option label="Cash Entry" value="Cash Entry" />
                  </el-select>
                </el-form-item>
              </td>
      ...
      <!-- Selected Items -->
      <el-card class="box-card mb-4">
        <el-divider>Account Entries</el-divider>
        <!--        show item-->
        ...
        <table class="table table-cus mb-10 table-hover">
          ...
          <tbody>
            ...
            <!--            Total-->
            <tr>
              <td class="fw-bold fs-3" colspan="2">
      ...
      <el-card class="box-card mb-4">
        <el-divider>Reference</el-divider>
        <!--        show item-->
        <div class="row">
          <div class="col-4" v-if="data.entry_type == 'Bank Entry'">
            <label class="required fs-6 fw-bold mb-1">Reference Number</label>
            <div class="">
              <el-form-item
                size="small"
                class="mb-0 w-100"
          ...
          <div class="col-4" v-if="data.entry_type == 'Bank Entry'">
            <label class="required fs-6 fw-bold mb-1">Reference Date</label>
            <div class="">
              <el-form-item
                size="small"
                class="mb-0 w-100"
          ...
          <div class="col-4">
            <label class="required fs-6 fw-bold mb-1">User Remark</label>
            <div class="">
              <el-form-item
                size="small"
                class="mb-0 w-100"
        ...
        <div class="row mt-3">
          <div class="col-4">
            <label class="required fs-6 fw-bold mb-1">Bill No</label>
            <div class="">
              <el-form-item
                size="small"
                class="mb-0 w-100"
          ...
          <div class="col-4">
            <label class="required fs-6 fw-bold mb-1">Bill Date</label>
            <div class="">
              <el-form-item
                size="small"
                class="mb-0 w-100"
          ...
          <div class="col-4">
            <label class="required fs-6 fw-bold mb-1">Due Date</label>
            <div class="">
              <el-form-item
                size="small"
                class="mb-0 w-100"
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      setCurrentPageBreadcrumbs("Journal Entry", ["General Ledger"]);
    });
        ...
        if (result.value) {
          ...
          formRef.value.validate((valid) => {
            ...
            if (valid) {
              ...
              //   store
              //     .dispatch(ACTIONS.ACCOUNT.CREATE_OPENING_BALANCE, data.value)
              //     .then(() => {
              //       loading.value = false;
              //       // Success Modal
              //       Swal.fire({
  ...
  watch: {
    calculateCreditTotal: {
      ...
      handler: function (newVal) {
        this.data.total_credit_amount = newVal;
      },
    },
    ...
    calculateDebitTotal: {
      deep: true,
      handler: function (newVal) {
        this.data.total_debit_amount = newVal;
      },
    },
  },
});
