  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered mw-900px">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="modal_add_lc_header">
          <!--begin::Modal title-->
          <h2 class="fw-bolder">Open New LC</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="modal_add_lc_close"
        ...
        <el-form :model="lcData" :rules="rules" ref="formRef">
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            >
                  ...
                  <el-form-item size="small" prop="issuing_bank">
                    ...
                    >
                      <el-option
                        ...
                        v-bind:key="bank.id"
                      >
                        <!--                        <span style="float: left">{{ bank.number }}</span>-->
                        <!--                        <span-->
                        <!--                          style="-->
                        <!--                            float: right;-->
                        ...
                        <!--                            font-size: 13px;-->
                        <!--                          "-->
                        <!--                          >{{ bank.bank_account_head_name }}</span-->
                        <!--                        >-->
                      </el-option>
                    </el-select>
                    <div
                ...
                <div class="col-md-6 fv-row">
                  ...
                  <el-form-item size="small" prop="bank_total_amount_bdt">
                    ...
                    <el-descriptions border>
                      ...
                      >
                        {{
                          lcData.bank_total_amount_bdt.toLocaleString(
                            undefined,
                            {
                ...
                <div class="col-md-6 fv-row">
                  ...
                  <el-form-item size="small" prop="under_total_amount_bdt">
                    ...
                    <el-descriptions border>
                      ...
                      >
                        {{
                          lcData.under_total_amount_bdt.toLocaleString(
                            undefined,
                            {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
              ...
              <!--begin::Input group-->
              <!--begin::Row-->
              <div v-show="false" class="row g-9">
                <!--              Open 10% -- Read Only-->
                <div class="col-md-6 fv-row">
                  <!--begin::Description-->
...
export default defineComponent({
  ...
  setup() {
    ...
    const addLcModalRef = ref<null | HTMLElement>(null);
          ...
          formRef.value.validate((valid) => {
            ...
            if (valid) {
              ...
              setTimeout(() => {
                ...
                store
                  .dispatch(ACTIONS.LC.CREATE_LC, lcData.value)
                  .then(() => {
                    loading.value = false;
                    // Success Modal
                    Swal.fire({
                      text: "Lc created successfully!",
                      icon: "success",
