<template>
  <template v-if="!loading">
    <!-- Submit -->
    <TitleAndButtons title="New Sales Order - (SAL-ORD-.YYYY.-)">
      <!--    Buttons-->
        ...
        <table class="table mb-0">
          <tbody class="">
            <tr class="justify-content-end">
              ...
              <!--            Project Location-->
              <td>
                <label class="required fs-6 fw-bold mb-1"
              ...
              <!--            Customer-->
              <td>
                <label class="required fw-bold mb-1">Customer</label>
                <div>
              ...
              <!--            SO Date-->
              <td>
                <label class="required fw-bold mb-1">Sales Oder Date</label>
                <div>
              ...
              <!--            Delivery Date-->
              <td>
                <label class="required fw-bold mb-1">Delivery Date</label>
                <div>
                  <el-form-item
                    size="small"
                    class="mb-0"
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      setCurrentPageBreadcrumbs("New Sales Order", ["Selling", "Sales Order"]);
    });
