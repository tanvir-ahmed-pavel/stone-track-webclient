    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_add_supplier_header">
          ...
          <!--begin::Close-->
          <div
            id="kt_modal_add_supplier_close"
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div class="row g-9">
              ...
              <div class="col-md-6 fv-row">
                ...
                >
                  <el-input
                    v-model="supplierData.supp_opening_balance"
                    type="number"
                    placeholder="Enter opening balance"
                  />
                  <div
                    v-if="
                      supplierData.supp_opening_balance != '' &&
            ...
            <div class="row g-9">
              ...
              <div class="col-md-6 fv-row">
                ...
                <el-form-item class="mb-4" size="small" prop="supplier_type">
                  <el-select v-model="supplierData.supplier_type">
                    <el-option
              ...
              <div class="col-md-6 fv-row">
                ...
                >
                  <el-select v-model="supplierData.supplier_group_id">
                    <el-option
                  ...
                  <div
                    v-if="
                      supplierData.supplier_group_id != '' &&
            ...
            <div class="row g-9">
              ...
              <div class="col-md-6 fv-row">
                ...
                >
                  <el-input
                    v-model="supplierData.supp_primary_email"
                    type="text"
                    placeholder="Enter supplier email"
                  />
                  <div
                    v-if="
                      supplierData.supp_primary_email != '' &&
              ...
              <div class="col-md-6 fv-row">
                ...
                >
                  <el-input
                    v-model="supplierData.supp_primary_mobile_no"
                    type="email"
                    placeholder="Enter supplier mobile"
                  />
                  <div
                    v-if="
                      supplierData.supp_primary_mobile_no != '' &&
            ...
            <div class="row g-9">
              <div class="col-md-12 fv-row">
                ...
                >
                  <el-input
                    v-model="supplierData.supp_primary_address"
                    type="text"
                    placeholder="Enter supplier name"
                  />
                  <div
                    v-if="
                      supplierData.supp_primary_address != '' &&
            ...
            <div class="row g-9">
              ...
              <div class="col-md-6 fv-row">
                ...
                >
                  <el-input
                    v-model="supplierData.supp_primary_city"
                    type="text"
                    placeholder="Enter city"
                  />
                  <div
                    v-if="
                      supplierData.supp_primary_city != '' &&
              ...
              <div class="col-md-6 fv-row">
                ...
                >
                  <el-input
                    v-model="supplierData.supp_primary_state"
                    type="text"
                    placeholder="Enter state"
                  />
                  <div
                    v-if="
                      supplierData.supp_primary_state != '' &&
            ...
            <div class="row g-9">
              ...
              <div class="col-md-6 fv-row">
                ...
                >
                  <el-input
                    v-model="supplierData.supp_primary_zip_code"
                    type="text"
                    placeholder="Enter post code"
                  />
                  <div
                    v-if="
                      supplierData.supp_primary_zip_code != '' &&
              ...
              <div class="col-md-6 fv-row">
                ...
                >
                  <el-select v-model="supplierData.supp_primary_country">
                    <el-option
                  ...
                  <div
                    v-if="
                      supplierData.supp_primary_country != '' &&
          ...
          <div class="modal-footer flex-center">
            <!--begin::Button-->
            <!-- <button type="reset" id="kt_modal_add_supplier_cancel" class="btn btn-light me-3">Reset</button> -->
            <button
...
export default defineComponent({
  ...
  methods: {
    ...mapActions({
      createSupplier: ACTIONS.SUPPLIER.CREATE_SUPPLIER,
    }),
    ...
    async createNewSupplier() {
      this.loading = true;
      const data = JSON.parse(JSON.stringify(this.supplierData));

      let msg = await this.createSupplier(data);
      ...
      if (msg == "success") {
        Swal.fire({
          ...
          this.resetForm();
          hideModal(this.addSupplierModalRef);
        });
