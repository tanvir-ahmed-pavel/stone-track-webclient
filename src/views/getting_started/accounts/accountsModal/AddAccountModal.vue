  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="modal_add_account_header">
          <!--begin::Modal title-->
          <h2 class="fw-bolder">Add an Account</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="modal_add_account_close"
            @click="hide()"
        ...
        <!--end::Modal header-->
        <!--begin::Form-->
        <el-form :model="accountData" :rules="rules" ref="formRef">
          <!--begin::Modal body-->
          <div class="modal-body py-10 px-lg-17">
            <!--begin::Scroll-->
            <div
              class="scroll-y me-n7 pe-7"
              id="modal_add_account_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#modal_add_account_header"
              data-kt-scroll-wrappers="#modal_add_account_scroll"
              data-kt-scroll-offset="300px"
            >
              <!--              Account Head Name && Parent Account-->
              <!--begin::Input group-->
              <!--begin::Col-->
              <div class="row g-9">
                ...
                <div class="col-md-6 fv-row">
                  ...
                  <el-form-item class="mb-4" size="small" prop="parent_id">
                    <el-input
                      readonly
                      v-model="accountData.parent_name"
                      type="text"
              ...
              <div v-show="accountData.account_type_id == 1">
                ...
                <div class="row g-9">
                  ...
                  <div class="col-md-12 fv-row">
                    ...
                    >
                      <el-input
                        v-model="accountData.bank_account_name"
                        type="text"
                        placeholder="Enter account bank name"
                      />
                      <div
                        v-if="
                          accountData.bank_account_name != '' &&
                          errorMsgs.bank_account_name != ''
                        "
                        class="el-form-item__error"
                      >
                        <div
                          v-for="errMsg in errorMsgs.bank_account_name"
                          :key="errMsg"
                        >
                          {{ errMsg }}
                        </div>
                ...
                <div class="row g-9">
                  ...
                  <div class="col-md-6 fv-row">
                    ...
                    <!--begin::Input-->
                    <el-form-item class="mb-4" size="small" prop="branch">
                      <el-input
          ...
          <div class="modal-footer flex-center">
            ...
            <!--begin::Close-->
            <button @click="hide()" class="btn btn-sm btn-danger">
              Cancel
...
export default defineComponent({
  ...
  setup(props) {
    ...
    watch(
      () => props.node,
      () => {
        accountData.value.parent_name = props.node!.self_parent;
        accountData.value.root_type = props.node!.root_type;
        accountData.value.parent_id = Number(props.node!.id);
      }
    );
          ...
          formRef.value.validate((valid) => {
            ...
            if (valid) {
              ...
              setTimeout(() => {
                ...
                store
                  .dispatch(ACTIONS.ACCOUNT.CREATE_ACCOUNT, accountData.value)
                  .then(() => {
                    loading.value = false;
                    store.dispatch(ACTIONS.ACCOUNT.FETCH_ACCOUNT_LIST);
                    // Success Modal
                    Swal.fire({
