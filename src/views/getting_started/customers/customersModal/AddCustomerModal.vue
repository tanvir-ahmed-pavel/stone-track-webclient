  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="modal_add_customer_header">
          <!--begin::Modal title-->
            ...
            >
              ...
              <div class="row g-9">
                ...
                <div class="col-md-6 fv-row">
                  ...
                  >
                    <el-input
                      v-model="customerData.cus_opening_balance"
                      type="number"
                      placeholder="Enter opening balance"
                    />
                    <div
                      v-if="
                        customerData.cus_opening_balance != '' &&
              ...
              <div class="row g-9">
                ...
                <div class="col-md-6 fv-row">
                  ...
                  >
                    <el-input
                      v-model="customerData.cus_primary_email"
                      type="text"
                ...
                <div class="col-md-6 fv-row">
                  ...
                  >
                    <el-input
                      v-model="customerData.cus_primary_mobile_no"
                      type="email"
              ...
              <div class="row g-9">
                <div class="col-md-12 fv-row">
                  ...
                  >
                    <el-input
                      v-model="customerData.cus_primary_address"
                      type="text"
                      placeholder="Enter customer name"
                    />
                    <div
              ...
              <div class="row g-9">
                ...
                <div class="col-md-6 fv-row">
                  ...
                  >
                    <el-input
                      v-model="customerData.cus_primary_city"
                      type="text"
                ...
                <div class="col-md-6 fv-row">
                  ...
                  >
                    <el-input
                      v-model="customerData.cus_primary_state"
                      type="text"
              ...
              <div class="row g-9">
                ...
                <div class="col-md-6 fv-row">
                  ...
                  >
                    <el-input
                      v-model="customerData.cus_primary_zip_code"
                      type="text"
