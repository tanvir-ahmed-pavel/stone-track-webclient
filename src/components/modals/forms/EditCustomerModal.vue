            ...
            >
              ...
              <div class="fv-row mb-7">
                ...
                <el-form-item prop="cus_primary_email">
                  <el-input v-model="customerEditData.cus_primary_email" />
                  <div
                    v-if="
              ...
              <div class="fv-row mb-7">
                ...
                <el-form-item prop="cus_primary_mobile_no">
                  <el-input v-model="customerEditData.cus_primary_mobile_no" />
                  <div
                    v-if="
              ...
              <div class="d-flex flex-column mb-7 fv-row">
                ...
                <el-form-item prop="customer_status">
                  <el-select v-model="customerEditData.customer_status">
                    <el-option
              ...
              >
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                  ...
                  <el-form-item prop="cus_primary_address">
                    <el-input v-model="customerEditData.cus_primary_address" />
                    <div
                      v-if="
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                  ...
                  <el-form-item prop="cus_primary_city">
                    <el-input v-model="customerEditData.cus_primary_city" />
                    <div
                      v-if="
                ...
                <div class="row g-9 mb-7">
                  ...
                  <div class="col-md-6 fv-row">
                    ...
                    <el-form-item prop="cus_primary_state">
                      <el-input v-model="customerEditData.cus_primary_state" />
                      <div
                        v-if="
...
export default defineComponent({
  ...
  computed: {
    ...mapGetters({
      ...
      customerEditData: GETTERS.CUSTOMER.customerEditData,
    }),
  },
